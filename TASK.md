...
4. **Стэк** - fastapi + pydantic + sqlalchemy + alembic
...
- Список организаций, которые находятся в заданном радиусе/прямоугольной области относительно указанной точки на карте (поиск через здания, т.к. координаты привязаны к зданиям)

> **Предположение:** в оригинальном задании формулировка "Список организаций... Список зданий" трактуется как два отдельных эндпоинта - поиск зданий и поиск организаций в заданной географической области. Координаты есть только у зданий, поэтому поиск организаций работает через их здания.
